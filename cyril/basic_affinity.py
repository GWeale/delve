...
def main():
    ...
    W_rbf = rbf_affinity(X, gamma=0.03, threshold=1e-2)
    ...
    merged_df = features_knn.join(features_kmeans, lsuffix='_knn', rsuffix='_kmeans')


    sns.heatmap(merged_df, cmap='viridis', vmin=0, vmax=1, annot=False, fmt=".3f")
    plt.show()
